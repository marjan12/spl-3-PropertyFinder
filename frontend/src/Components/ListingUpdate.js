...
function ListingUpdate(props) {
  ...
  const initialState = {
    ...
    priceValue: props.listingData.price || 0,
    rentalFrequencyValue: props.listingData.rental_frequency || "",
    roomsValue: props.listingData.rooms || 0,
    furnishedValue: props.listingData.furnished || false,
    poolValue: props.listingData.pool || false,
    elevatorValue: props.listingData.elevator || false,
    cctvValue: props.listingData.cctv || false,
    parkingValue: props.listingData.parking || false,
    sendRequest: 0,
    openSnack: false,
    disabledBtn: false,
  };
      ...
      async function UpdateProperty() {
        ...
        try {
          const response = await Axios.patch(
            `http://127.0.0.1:8001/api/listings/${props.listingData.id}/update/`,
            formData
          );
